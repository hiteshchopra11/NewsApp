package com.sources.app.Adapters
...
class SourceLinearAdapter(private val sources: ArrayList<SourceX>) :
    RecyclerView.Adapter<SourceLinearAdapter.DataViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder =
        DataViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.source_linear_item, parent, false)
        )
